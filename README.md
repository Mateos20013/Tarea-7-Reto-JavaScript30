...
## Demo en Vivo
**[Ver Demo](https://mateos20013.github.io/Tarea-7-Reto-JavaScript30/)**
...
1. Clona el repositorio:
   ```bash
   git clone https://github.com/Mateos20013/Tarea-7-Reto-JavaScript30.git
   ```
2. Navega al directorio:
   ```bash
   cd Tarea-7-Reto-JavaScript30
   ```
